package com.sruthi.thiranx.data.repository;
...
public class ThiranXDB {
    ...
    public Alert addNotification(Alert alert) {
        if (alert == null || alert.getEmployeeId() == null) return null;
        notificationPk++;
        alert.setId(notificationPk);
    ...
    public List<Alert> getNotificationsFor(Long employeeId) {

package com.sruthi.thiranx.features.task.assign;
...
class TaskAssignModel {
    ...
    void assign(Task task, Long assigneeId) {
        ...
        alert.setEmployeeId(assigneeId);
        alert.setTaskId(updated.getId());
        alert.setType(Alert.NotificationType.TASK_ASSIGNED);
        alert.setMessage("You have been assigned task: " + updated.getTitle());

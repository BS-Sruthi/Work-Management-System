package com.sruthi.thiranx.features.register;
...
public class RegisterView {
    ...
    private void startSignUp() {
        ...
        boolean firstEmployee = registerModel.isFirstEmployee();
        ...
        registerModel.registerEmployee(name, email, password, mobile, dob, role, reportingTo);
    }
    ...
    private String promptName() {
        while (true) {
            ...
            String error = registerModel.validateName(input);
    ...
    private String promptEmail() {
        while (true) {
            ...
            String input = scanner.nextLine();
            String error = registerModel.validateEmail(input);
            if (error == null) return input.trim();
            showErrorMessage(error);
        }
    }
    ...
    private String promptPassword() {
        while (true) {
            ...
            String input = scanner.nextLine();
            String error = registerModel.validatePassword(input);
            if (error != null) {
                showErrorMessage(error);
                continue;
            }
            ...
            String confirmError = registerModel.validateConfirmPassword(input, confirm);
    ...
    private String promptMobile() {
        while (true) {
            ...
            String input = scanner.nextLine();
            String error = registerModel.validateMobile(input);
            if (error == null) return input.trim();
            showErrorMessage(error);
        }
    }
    ...
    private Long promptDob() {
        while (true) {
            ...
            String input = scanner.nextLine();
            Long dob = registerModel.parseDateOfBirth(input);
    ...
    private Employee.Role promptRole() {
        while (true) {
            ...
            String input = scanner.nextLine();
            Employee.Role role = registerModel.parseRole(input);
    ...
    private Long promptReportingManager() {
        List<Employee> managers = registerModel.getActiveManagers();
        if (managers.isEmpty()) {

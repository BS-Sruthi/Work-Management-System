...
class RegisterModel {
    ...
    RegisterModel(RegisterView registerView) {
    ...
    void registerEmployee(String name, String email, String password,
                          String mobile, Long dob, Employee.Role role,
                          Long reportingTo) {
        ...
        if (saved == null) {
            registerView.showErrorMessage("Could not create account. Please try again.");
            return;
        }
        registerView.onSignUpSuccessful(saved);
    }
}
